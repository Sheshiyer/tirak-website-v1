...
// Centralized UI variants to improve hot-reload fidelity.
...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50",
  {
    ...
    compoundVariants: [
      { variant: "default", size: "default", class: "h-10" },
      { variant: "secondary", size: "default", class: "h-10" },
    ],
    defaultVariants: {
      variant: "default",
      size: "default",
...
export const labelVariants = cva(
  "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70",
  {
    variants: {
      variant: {
        default: "",
        formField: "mb-2 block text-sm font-medium",
      },
    },
    defaultVariants: {
      variant: "default",
...
export const sheetVariants = cva("fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out", {
  variants: {
    side: {
